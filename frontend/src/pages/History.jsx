...
export default function History({ content, open }) {
  return (
    <div className="history-page max-w-4xl mx-auto py-8 px-4">
      <div className="history-head flex items-center gap-3 mb-8">
        ...
        {content.length ? content.map((item) => (
          ...
          >
            ...
            <div className="history-card-copy flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">{item.sourceType === "youtube_url" ? "YouTube Video" : "Uploaded File"} • {item.language}</p>
            </div>
